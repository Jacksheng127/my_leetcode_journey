...
class ShortestSubarrayWithORAtLeastKII{
    ...
    public static void main(String[] args) {
        ShortestSubarrayWithORAtLeastKII obj = new ShortestSubarrayWithORAtLeastKII();
        System.out.println(obj.minimumSubarrayLength(new int [] {1, 2, 3}, 2));
    }
}